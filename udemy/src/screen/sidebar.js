  ...
  return (
    <div className="sidebar relative">
      ...
      <div className="updated-course flex aic ">
        ...
        <div className="lbl coursename c333 s15 ">Updated course <br></br>by harsheen</div>
      </div>
      ...
      <div className="stats flex">
        <div className="stats-box flex ">
          <div>
            {" "}
            <FaUserShield className="ico s24 icon-shield ico-points"></FaUserShield>
          </div>
        ...
        <div className="stats-box flex">
          <div>
            <FaBatteryFull className="ico ico-battery s24 icon-battery-90"></FaBatteryFull>
          </div>
          <div>
            {" "}
            <h2 className="val s15 c777 fontb">45.3%</h2>
          </div>
      ...
      <div>
        <div className="me">
          <div>
            <img src={person} className="lbl" />{" "}
          </div>
          <div className="name s15 c777">
            harsheen kaur<br></br>@harsheenkaur
          </div>
        </div>
      </div>
    </div>
